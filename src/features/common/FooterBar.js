...
export default (props) => {
  ...
  return (
    ...
    <Modal title={'选择工单类型'} className="foot-model" centered footer={null} bodyStyle={{height: 'calc(100vh - 127.5px - 76px)', padding: '0px'}}  visible={visible} onCancel={handleCancel}>
