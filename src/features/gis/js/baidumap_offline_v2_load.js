...
var bdmapcfg = {
  ...
  'tiles_dir':'http://192.168.3.244:8080/tiles/'   //瓦片图的目录，为空默认在 baidumap_v2/tiles/ 目录
};
...
(function(){
  ...
  //加载地图API主文件
  document.write('<script type="text/javascript" src="js/baidumap_offline_v2_20160921_min.js"></script>');
})();
